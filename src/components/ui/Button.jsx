...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "text-white shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95",
        destructive: "text-white shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95",
        outline: "border-2 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95",
        secondary: "shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95",
